...
langs.esES = {
	["completion0"] = "El temporizador expiró para %s con %s, te pasaste %s del límite de tiempo.",
	["completion1"] = "Supera el cronómetro de %s en %s. Ibas %s por delante del cronómetro y has fallado +2 por %s.",
	["completion2"] = "Supera el cronómetro de +2 %s en %s. Te has adelantado un %s al cronómetro de +2 y te has saltado el de +3 por un %s.",
	["completion3"] = "Supera el cronómetro de +3 %s en %s. Te has adelantado en %s al cronómetro de +3.",
	["completionSplits"] = "Los tiempos de división fueron: %s.",
	...
	["config_smallAffixes"] = "Reducir el tamaño de los iconos de afijo en la ventana del temporizador",
	["config_splitsFormat_1"] = "Desactivado",
	["keystoneFormat"] = "[Piedra angular: %s - Nivel %d]",
	["scheduleMissingKeystone"] = "Requiere una Piedra Mítica de nivel 7+ en tu inventario para mostrarse.",
...
langs.ruRU = {
	...
	config_progressTooltipMDT = "Использовать данные Mythic Dungeon Tools для подсказок",
	...
	config_autoGossip = "Автоматически запускать диалоги во время прохождения подземелья М+ (например, Один).",
	config_cosRumors = "Отправлять в групповой чат подсказки от \"Болтливого сплетника\" во время прохождения Квартала Звезд",
	config_silverGoldTimer = "Показывать таймер для +2 и +3 бонусных сундуков одновременно",
	config_completionMessage = "Показывать сообщение с итоговым временем прохождения подземелья М+.",
	config_showSplits = "Показывать разницу времени для каждого события в окне прогресса",
	...
	config_smallAffixes = "Уменьшить значки аффиксов в окне таймера",
	config_deathTracker = "Показывать счётчик смертей в окне таймера",
	scheduleTitle = "График аффиксов",
	...
	scheduleMissingKeystone = "Для отображения требуется ключ 7+ уровня в Вашем инвентаре.",
	scheduleUnknown = "Обновленный график аффиксов в настоящее время неизвестен.",
	config_hideTalkingHead = "Скрыть диалоги с 'Говорящей головой' во время прохождения подземелья М+",
	config_resetPopup = "Показывать всплывающее окно для сброса подземелий при выходе из завершенного подземелья М+",
	partyKeysTitle = "Ключи группы",
	newKeystoneAnnounce = "Новый ключ: %s",
	currentKeystoneText = "Текущий: |cFFFFFFFF%s|r",
	config_announceKeystones = "Объявлять о новых ключах М+ Вашей группе",
	config_schedule = "Отображение аффиксов в ключах и ключей группы (требуется перезагрузка интерфейса)",
	["dungeon_Shadowmoon Burial Grounds"] = "Некрополь Призрачной Луны",
	["dungeon_Temple of the Jade Serpent"] = "Храм Нефритовой Змеи",
	timeLimit = "Лимит времени %s",
	timeLost = "Потерянное время",
}
...
langs.deDE = {	
	...
	config_progressTooltipMDT = "Nutze die Daten von Mythic Dungeon Tools für den Tooltip",
